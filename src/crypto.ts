// --- Encryption --------------------------------------------------------
// The Gemini API key can optionally be encrypted at rest with a user-chosen
// password. The password itself is never persisted - only kept in memory
// for the current Obsidian session (see DelvePlugin.sessionPassword).
...
export const ENCRYPTION_CHECK_VALUE = "delve-encryption-check";
